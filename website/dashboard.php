<?php
    ...
    if(isset($_POST['update'])){
        ...
        if(isset($update_id)){
            $sql = "UPDATE users_db SET firstname='$_POST[firstname]',lastname='$_POST[lastname]',email='$_POST[email]',username='$_POST[username]',password='$_POST[password]',dob='$dob',gender='$_POST[gender]',hobby='$hob',cities='$location',modified=NOW()
            WHERE id=$update_id";
...
<!--going for the setting as like list -->
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <?php foreach($result as $row){ ?>
                                <tr>
                                   ...
                                   <!-- as it was inline so one line for name <td class="info"><?php /*echo $row['lastname'] */?></td>-->
